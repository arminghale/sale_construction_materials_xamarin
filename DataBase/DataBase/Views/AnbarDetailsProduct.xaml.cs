...
namespace DataBase.Views
{
    ...
    public partial class AnbarDetailsProduct : ContentPage
    {
        private List<string> f = new List<string>();
        public AnbarDetailsProduct(Product product)
        {
            InitializeComponent();
            ActivitySpinner.IsRunning = false;
            menu();
            var response = Consts.client.GetAsync("http://localhost:1212/Anbar/api/PrGroupIndex/").Result;
