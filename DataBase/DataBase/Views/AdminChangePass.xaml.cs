...
namespace DataBase.Views
{
    ...
    public partial class AdminChangePass : ContentPage
    {
        public AdminChangePass(int id)
        {
            InitializeComponent();
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            var response2 = Consts.client.PostAsync("http://localhost:1212/Admin/api/ChangePass", formContent).Result;
