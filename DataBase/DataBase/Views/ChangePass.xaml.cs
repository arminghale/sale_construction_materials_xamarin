...
namespace DataBase.Views
{
    ...
    {
        public ChangePass(int id,string code)
        {
            InitializeComponent();
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            formVariables.Add(new KeyValuePair<string, string>("activecode", code));
                            ...
                            var response2 = Consts.client.PostAsync("http://localhost:1212/api/ForgetPass2/", formContent).Result;
