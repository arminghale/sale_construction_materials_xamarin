...
namespace DataBase.Views
{
    ...
    public partial class UserChangePass : ContentPage
    {
        public UserChangePass(int id)
        {
            InitializeComponent();
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            var response2 = Consts.client.PostAsync("http://localhost:1212/User/api/ChangePass", formContent).Result;
